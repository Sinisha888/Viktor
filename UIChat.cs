...
public partial class UIChat : MonoBehaviour
{
    ...
    private string recountMeter = "/Dmgmetershow";
    public GameObject recountPanel;
    bool eatActivation;
    

    void Awake()
    {
        recountPanel.SetActive(false);
    }
    ...
    void Update()
    {
        ...
        if(messageInput.text == recountMeter )
        {
            recountPanel.SetActive(true);
            messageInput.text ="";
        }
    }
    ...
    public void AddMessage(ChatMessage message)
    {
        ...
        // Instantiate the GameObject without setting its parent
